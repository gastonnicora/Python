    ...
    def insert_article_in_bulk(cls, articles_data):
        ...
        for article_data in articles_data:
            article = Article(
                ...
                next=None, 
                before=None,  
                finished=1 if  article_data["auctionF"]==1  or (article_data["dateOfFinish"] and now >= datetime.datetime.strptime(article_data["dateOfFinish"], date_format)) else 0,
                started=1 if article_data["auctionF"]==1  or (article_data["dateOfStart"] and now >= datetime.datetime.strptime(article_data["dateOfStart"], date_format))  else 0
            )
